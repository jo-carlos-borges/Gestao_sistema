...
const submitForm = async () => {
  ...
  try {
    const newItem = await itemsStore.addItem({
    ...
    errorMessage.value = error.message || 'An error occurred while adding the item.';
  } finally {
    loading.value = false;
  }
};
    ...
    <div class="card max-w-2xl mx-auto">
      <form @submit.prevent="submitForm">
        ...
        <div class="mb-6">
          ...
          <div v-if="categoriesLoading" class="flex items-center text-gray-500 text-sm mb-2">
          ...
          <div class="mt-2 text-sm">
            <router-link to="/categories/add" class="text-primary-600 hover:text-primary-800">
              + Add new category
            </router-link>
          </div>
        </div>
